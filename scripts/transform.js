...
const OUT_FILE = path.join(ROOT, 'src', 'data', 'cafes.js');
...
const js = `// AUTO-GENERATED by scripts/transform.js — do not edit by hand.
// Source: Geoapify Places API. Phase 2 (Google Places) will enrich ratings/photos/attributes.
...
console.log(`\n📄  Saved → src/data/cafes.js  (${cafes.length} cafes)`);
